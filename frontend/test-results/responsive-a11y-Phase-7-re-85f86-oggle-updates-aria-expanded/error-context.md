...
- Name: responsive-a11y.spec.ts >> Phase 7 responsive + accessibility smoke >> mobile navigation toggle updates aria-expanded
- Location: tests/qa/responsive-a11y.spec.ts:10:7
...
Locator: getByRole('button', { name: /open navigation|close navigation/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /open navigation|close navigation/i })
